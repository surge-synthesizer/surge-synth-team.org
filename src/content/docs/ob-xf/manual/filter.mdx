...
- **Env Amt**: This knob sets the amount of unipolar modulation of the filter cutoff frequency by the filter envelope. The polarity will either be positive or negative, based on the setting of the **Invert** button in the [Filter Envelope Section](#filter-envelope).
