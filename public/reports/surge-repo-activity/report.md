...
|---|---|---|---|---|
| [#8322](https://github.com/surge-synthesizer/surge/pull/8322) | FilterAnalysis: display extra filter parameters in Parameters mode; fix hint-field misuse | copilot-swe-agent | 4mo | draft, stale |
| [#8525](https://github.com/surge-synthesizer/surge/pull/8525) | Refuse a WAV whose data chunk cannot be sized | manuaudio | 2d | — |
| [#8528](https://github.com/surge-synthesizer/surge/pull/8528) | Bound the patch and wavetable readers by the data they were given | manuaudio | 1d | — |
...
| PR | Title | Author | Age | Status |
|---|---|---|---|---|
| [#4](https://github.com/surge-synthesizer/shortcircuit-factory-content/pull/4) | Add CC0 factory content: [wt-batch-1] | wintocode | 6mo | stale |
...
*Authors whose first ever merged PR in surge-synthesizer landed since 2026-07-17. Bots excluded.*
